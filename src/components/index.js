...
export { default as Fade } from './fade/fade.component'
export { default as Background } from './background/background.component'
export { default as FeaturedProjects } from './featured-projects/featured-projects.component'
...
export { default as MenuItem } from './MenuItem/menu-item.component'
// export { default as Header } from './header/header.component'
export { default as Tilt } from './tilt'
export { default as Parallax } from './parallax'
export { default as CardStack } from './cardstack/cardstack.component'
export { default as CTA } from './call-to-action/cta.component'
